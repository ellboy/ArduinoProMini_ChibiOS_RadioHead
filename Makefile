...
#         ../RadioHead-1.62/RadioHead/RHutil/ChibiosInterface.cpp \
#          ../RadioHead-1.62/RadioHead/RHNRFSPIDriver.cpp \
#          ../RadioHead-1.62/RadioHead/RHHardwareSPI.cpp \
#         ../RadioHead-1.62/RadioHead/RHGenericSPI.cpp \
...
ELFSIZE_DETAIL = avr-nm --size-sort -S  $(TARGET).elf > object.size
...
sizeafter:
	...
	2>/dev/null; echo; fi
	@if test -f $(TARGET).elf; then  $(ELFSIZE_DETAIL); \
	2>/dev/null; echo; fi
